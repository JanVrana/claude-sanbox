...
configure_sandbox() {
  ...
  {
    echo "# Claude Code Sandbox configuration"
    echo "# Generated by install.sh — edit freely"
    echo "# These are sourced as defaults; env variables override them at runtime."
    echo ""
    echo "CLAUDE_NETWORK=\"$cfg_network\""
    echo "CLAUDE_MEMORY=\"$cfg_memory\""
